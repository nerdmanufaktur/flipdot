...
void loop() {
  ...
  delay(500);
  board.render_string_small("12 34\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("12:35\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("12 35\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("HpyHour\0", 10.4*CHAR_OFFSET_SMALL+1, 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string_small("Ckts 7\0", 10.4*CHAR_OFFSET_SMALL+1, 8, FLIPDOT::FLIPDOT::ZERO_NONE);
  board.render_string_small("12:36\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("12 36\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("12:37\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("12 38\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("12:39\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("12 39\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string_small("Tagesmenu\0", 4*CHAR_OFFSET_SMALL, 0);
  board.render_string_small("ist aus!  \0", 4*CHAR_OFFSET_SMALL, 8,FLIPDOT::FLIPDOT::ZERO_NONE);
  delay(500);
  board.render_string_small("12:40\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("12 41\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
   delay(500);
  board.render_string_small("12:42\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("12:42\0", 0, 4,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(1000);
  board.render_string_small("     \0", 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string("0\0", 8,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("     \0", 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string("1\0", 8,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("     \0", 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string("2\0", 8,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("     \0", 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string("3\0", 8,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("     \0", 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string("4\0", 8,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("     \0", 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string("5\0", 8,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("     \0", 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string("6\0", 8,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("     \0", 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  board.render_string("7\0", 8,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
  delay(500);
  board.render_string_small("     \0", 0,FLIPDOT::FLIPDOT::ZERO_LOCALLY);
